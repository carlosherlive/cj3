...
<div class="body-container">
    <div class="col-md-12 no-padd">
        <div>
                <?php echo '<section class="model_group">';
		    $count=0;
			$nTime=time();
			...
			$select="select * from chatmodels c where not exists(select id from blockedcountry b where  b.model=c.user  and b.cc='$cc') and c.status='online' AND c.category='$cat' order by rand() limit 48;";
			$result = mysql_query($select);
