...
{
	var getStyle, _parent, clear, drawRoundRect;
	function ButtonSkin() {
		super();
	}
	function init() {
	...
	function drawHaloRect(w, h) {
		var Register_6_ = this.getStyle("borderStyle");
		var Register_4_ = this.getStyle("themeColor");
		var Register_5_ = this._parent.emphasized;
		this.clear();
		switch (Register_6_){
		  case "falseup" :
			if (Register_5_){
				this.drawRoundRect(this.x, this.y, w, h, 5, 9542041, 100);
				this.drawRoundRect(this.x, this.y, w, h, 5, Register_4_, 75);
				...
				this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, Register_4_, 75);
		  ...
		  case "falsedown" :
			...
			this.drawRoundRect((this.x + 1), (this.y + 1), (w - 2), (h - 2), 4, Register_4_, 50);
			this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, [0, 14342874], 100, 0, "radial");
			this.drawRoundRect(this.x, this.y, w, h, 5, Register_4_, 40);
			this.drawRoundRect((this.x + 3), (this.y + 3), (w - 6), (h - 6), 2, 16777215, 100);
			this.drawRoundRect((this.x + 3), (this.y + 4), (w - 6), (h - 7), 2, Register_4_, 20);
			break;
		  case "falserollover" :
			this.drawRoundRect(this.x, this.y, w, h, 5, 9542041, 100);
			this.drawRoundRect(this.x, this.y, w, h, 5, Register_4_, 50);
			this.drawRoundRect((this.x + 1), (this.y + 1), (w - 2), (h - 2), 4, [3355443, 16777215], 100, 0, "radial");
			this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, [0, 14342874], 100, 0, "radial");
			this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, Register_4_, 50);
			this.drawRoundRect((this.x + 3), (this.y + 3), (w - 6), (h - 6), 2, 16777215, 100);
			this.drawRoundRect((this.x + 3), (this.y + 4), (w - 6), (h - 7), 2, 16316664, 100);
			break;
		  case "falsedisabled" :
		  ...
		  case "truerollover" :
			...
			this.drawRoundRect(this.x, this.y, w, h, 5, Register_4_, 50);
			this.drawRoundRect((this.x + 1), (this.y + 1), (w - 2), (h - 2), 4, [3355443, 16777215], 100, 0, "radial");
			this.drawRoundRect((this.x + 1), (this.y + 1), (w - 2), (h - 2), 4, Register_4_, 40);
			this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, [0, 14342874], 100, 0, "radial");
			this.drawRoundRect((this.x + 2), (this.y + 2), (w - 4), (h - 4), 3, Register_4_, 40);
			this.drawRoundRect((this.x + 3), (this.y + 3), (w - 6), (h - 6), 2, 16777215, 100);
			this.drawRoundRect((this.x + 3), (this.y + 4), (w - 6), (h - 7), 2, 16316664, 100);
			break;
		  case "truedisabled" :
	...
	static var classConstructed = ButtonSkin.classConstruct();
