dynamic class mx.skins.CustomBorder extends mx.skins.Border
{
	...
	function draw(Void) {
		if (this.l_mc == undefined){
			var Register_2_ = this.setSkin(tagL, this.leftSkin);
			if (this.horizontal){
		...
		if (this.m_mc == undefined){
			this.setSkin(CustomBorder.tagM, this.middleSkin);
			if (this.horizontal){
		...
		if (this.r_mc == undefined){
			this.setSkin(tagR, this.rightSkin);
			if (this.horizontal){
