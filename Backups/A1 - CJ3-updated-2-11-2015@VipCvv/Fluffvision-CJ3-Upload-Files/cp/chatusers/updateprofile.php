...
<p>&nbsp;</p>
<p>&nbsp;</p>
<table width="720" height="800" border="0" align="center" cellpadding="0" cellspacing="0" background="../../images/member-profile-bg.png">
      ...
      <form name="form1" method="post" action="updateprofile.php">
        ...
        <table width="1000" border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td width="185" align="right" class="form_definitions style1"> User name </td>
		...
		echo ">$row[name]</option>";
          ...
          <tr>
            ...
            <td valign="top">
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <INPUT TYPE="image" SRC="../../images/update.png" HEIGHT="52" WIDTH="99" BORDER="0" ALT="">
