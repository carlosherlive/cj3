  ...
  <tr>
	...
	<tr>
	  ...
	  <td align="left" class="form_definitions"><?=$birthDateString?></td>
        ...
        <tr>
          <td width="179" align="left" class="form_definitions">Payment Method: </td>
          <td align="left" class="form_definitions"><? echo $tempPMethod;?> </td>
        </tr>
        <tr>
          <td width="179" align="left" class="form_definitions">Details for Payment: </td>
          <td align="left" class="form_definitions"><? echo $tempPInfo;?> </td>
        </tr>
      </table>
    </div>
...
echo '<table width="1010"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
