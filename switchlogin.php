...
<div class="body-container">
    <div class="col-md-12" align="center">
        ...
        <a href="login_member.php" style="position: absolute;left: 50%;top: 25%;"><button class="btn w3-hide-small" style="color:#000">Members</button></a>
        <a href="login_member.php" style="position: absolute;left: 14%;top: 75%;"><button class="btn w3-hide-large" style="color:#000">Members</button></a>

        <a href="login_model.php" style="position: absolute;left: 50%;top: 45%;""><button class="btn w3-hide-small" style="color:#000">Performer</button></a>
        <a href="login_model.php" style="position: absolute;left: 60%;top: 75%;""><button class="btn w3-hide-large" style="color:#000">Performer</button></a>
    </div>
</div>
