...
?>
<embed flashvars="&fuser=<? echo $sUser; ?>&fmodel=<? echo $_GET[model]; ?>&fid=<? echo $sId; ?>&fmoney=<? echo $nMoney;?>&favorite=<? echo $nFav;?>&freetime=<? echo $freetime;?>&connection=<? echo $connection_string;?>&cpm=<? echo $cpm; ?>" src="thumbnail.swf" width="100%" height="100%" quality="high" wmode="transparent" pluginspage="https://get.adobe.com/es/flashplayer/" type="application/x-shockwave-flash"></embed>
