...
<div class="body-container">
	...
	<section class="login">
	    <div class="titulo"><i class="fa fa-user"></i>&nbsp;&nbsp;Performer Login</div>
	    <form id="loginform" action="" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div class="olvido">
        	<div class="col"><a href="registration/model.php" title="Register"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Register</a></div>
